...
private:
    std::map<CollectibleComponent::Type, std::string> _collectibles = {
            {CollectibleComponent::Type::UPGRADE, "../../client/assets/images/bonus/bonus_2_160x36_40x36.png"},
...
public:
    explicit Collectible(const Engine::Point<double> &pos, CollectibleComponent::Type type) : Engine::Entity()
    {
        ...
        this->addComponent<Engine::VelocityComponent>(Engine::Point<double>{0, 0});
